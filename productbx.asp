...
<%
	...
	set rs=Server.CreateObject("ADODB.Recordset")
		...
		if rs.state=1 then rs.close()
			news_sql=" select * from sq_jinrongcity.[Bx_tab] where 1=1 "
...
<div class="content3">
  ...
  <a href="productbxde.asp?id=<%response.Write(rs("id"))%>" target="_blank"><strong style="color:#F00; font-size:14px">我要点评</strong></a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="productbxsc.asp?id=<%response.Write(rs("id"))%>" target="_blank"><strong style="color:#F00; font-size:14px">我要收藏</strong></a>
  </li></UL>
    <% rs.movenext
			  else
				exit for
