...
if upload.form("butsave")<>"" then
	...
	rs.CursorLocation = 3
	link_sql = "select * from sq_jinrongcity.[jr_category] where 1=2"
	if rs.state = 1 then rs.close
	rs.open link_sql, connstr, 1, 3
	rs.addnew
	rs("pre_no")	= upload.form("pre_no")
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
	<TBODY>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
        				<td height="26" background="images/headerbg1.gif">&nbsp; <span class="headtext"><img src="images/dec_1.gif" width="11" height="11" align="absmiddle">添加搜索分类</span></td>
      				</tr>
      				<tr>
	...
	<TABLE cellSpacing=1 cellPadding="4" width="100%" align="center" border=0>
		...
		<TR>
			<TD align="right" width=106 bgColor="#E5EFF7"><font color="#FF0000">*</font> 类别：</TD>
			<TD colspan="3" align="left" bgColor="#F7F7F7">
				<select name="pre_no" id="pre_no">
					<option value=0>----请选择类别----</option>
					<!--理财-->
					<option value=1>--理财:投资时间--</option>
					<option value=2>--理财:投资金额--</option>
					<option value=3>--理财:投资收益--</option>
					<option value=4>--理财:星级--</option>
					<!--保险-->
					<option value=5>--保险:险种--</option>	
					<option value=6>--保险:月付金额--</option>
					<option value=7>--保险:利率/价值--</option>
					<option value=8>--保险:星级--</option>
				</select>
			</TD>
		</TR>
		<TR>
	...
	<tr>
          <td height="46" colspan="4" bgcolor="#E5EFF7"><div align="center">
              <div align="center">
                <div align="right">
                  <div align="center">
                    <input name="butsave" type="submit" class="buttomw" value="保&nbsp;&nbsp;存" onClick="return checkvalue();" />					        
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
