...
if upload.form("butsave")<>"" then
	...
	rs.CursorLocation = 3
	link_sql = "select * from sq_jinrongcity.[jr_link] where 1=2"
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
	<TBODY>
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
      				<tr>
        				<td height="26" background="images/headerbg1.gif">&nbsp; <span class="headtext"><img src="images/dec_1.gif" width="11" height="11" align="absmiddle">添加友情链接</span></td>
      				</tr>
      				<tr>
	...
	<TABLE cellSpacing=1 cellPadding="4" width="100%" align="center" border=0>
		...
		<TR>
			...
			<TD colspan="3" align="left" bgColor="#F7F7F7"><input type="text" id="title" name="title" size="45" class="a2" /></TD>
		</TR>
		<TR>
			<TD align="right" width=106 bgColor="#E5EFF7"><font color="#FF0000">*</font>url：</TD>
			<TD colspan="3" align="left" bgColor="#F7F7F7">
				<input type="text" id="url" name="url" size="45" class="a2" />
			</TD>
		</TR>
		<TR>
			<TD align="right"  width=106 bgColor="#E5EFF7"><font color="#FF0000">*</font> 是否显示：</TD>
			<TD colspan="3" align="left" bgColor="#F7F7F7">
			<input type="checkbox" name="is_show" value=1/>是
			<input type="checkbox" name="is_show" value=0 checked="checked" />否
			</TD>
		</TR>		
