...
<%
			...
			if rsLm.eof then
				response.write "请先添加栏目名称（热门词管理-> 添加热门词）"
				response.end 
			end if
%>
...
<form action="Menu_rmc_deal.asp" method="post" name="news_form" enctype="multipart/form-data">
...
<TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=1 cellPadding="4" width="100%" align="center" border=0>
			  <TBODY>
			  <TR>
				<TD align="right" width=131 bgColor="#E5EFF7"><span class="style1">* </span>信息标题：</TD>
			  ...
			  <TR>
				<TD align="right" width=131 bgColor="#E5EFF7" ><span class="style1">* </span>热门词栏目：</TD>
				...
				Wend
				%></select></TD>
				<TD width="113" align="right" bgColor="#E5EFF7"><span class="style1">*</span> 信息作者：</TD>
				<TD width="373" height=20 align="left" bgColor="#E5EFF7"><input name="txtauthor" type="text"  id="txtauthor" size="30" maxlength="100" title="关 键 字" class="a2"></TD>
			  </TR>
					
			  <TR>
				<TD align="right" width=131 bgColor="#E5EFF7"><span class="style1">*</span> 信息摘要：</TD>
				<TD colspan="3"  align="left" bgColor="#E5EFF7"><input name="txtsource" type="text"  id="txtsource" size="66" maxlength="100" title="新闻来源" class="a2"></TD>
				</TR>
			  <TR>
			    <TD align="right" bgColor="#E5EFF7" width="131"><span class="style1">*</span> 小 图 片：</TD>
             ...
             <TR>
			    <TD align="right" bgColor="#E5EFF7" width="131"><span class="style1">*</span> 大 图 片：</TD>
