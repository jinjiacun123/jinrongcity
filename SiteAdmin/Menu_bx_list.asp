...
<%
	...
	set rs_news=server.CreateObject("ADODB.recordset")
		news_sql="select * from sq_jinrongcity.[Bx_tab] where FParentID=0 "

		if request.Form("butall")<>"" then
			response.Redirect("Menu_bx_list.asp")
		end if	
	...
	if request("butdel")<>"" then
	 ...
	 ''''删除小图
	  sql="select Server_filepath from sq_jinrongcity.[Bx_tab] where id="& item
		...
		conn.execute "delete from sq_jinrongcity.[Bx_tab] where id="& item
		next   '循环执行删除语句
		response.Redirect("Menu_bx_list.asp")
	end if
...
function ShowRDlgRet(toLink,iW,iH)  //带返回值的框架对话框
 {  
	...
	function searchrecord(){
	  var bLogged;
	  bLogged=ShowRDlgRet('Menu_bx_find.asp',500,150);
...
<body>
<form name="form1" method="post" action="Menu_bx_list.asp">
        ...
        <td>
         <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#EBEBEB">
            <tr>
              ...
              <td width="13%" background="images/headerbg1.gif"><div align="center" class="headtext">公司名称</div></td>
			  <td width="26%" background="images/headerbg1.gif"><div align="center" class="headtext">产品名称</div></td>
			  <td width="9%" background="images/headerbg1.gif"><div align="center" class="headtext">月付金额</div></td>
              <td width="8%" background="images/headerbg1.gif"><div align="center" class="headtext">利率/价值</div></td>
              <td width="7%" background="images/headerbg1.gif"><div align="center" class="headtext">期限</div></td>
              <td width="6%" background="images/headerbg1.gif"><div align="center" class="headtext">险种</div></td>
              <td width="7%" background="images/headerbg1.gif"><div align="center" class="headtext">星级</div></td>
              <td width="7%" background="images/headerbg1.gif"><div align="center" class="headtext">点击次数</div></td>
              <td width="5%" background="images/headerbg1.gif"><div align="center" class="headtext">编辑</div></td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr <%if i mod 2 = 1 then response.Write("bgcolor='#FFFFFF'") else response.Write("bgcolor='#FAFAFA'")%>>
              ...
              <td><div align="center"><%=rs_news("clicked")%>次</div></td>
              <td><div align="center"><img src="images/del.gif" width="16" height="16" align="absmiddle"><a href="Menu_bx_edit.asp?id=<%=rs_news("ID")%>">编辑</a></div></td>
            </tr>
			<% rs_news.movenext
	  else
        exit for
