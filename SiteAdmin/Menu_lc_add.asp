...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="27" background="images/headerbg1.gif">&nbsp; <span class="headtext"><img src="images/dec_1.gif" width="11" height="11" align="absmiddle"> 发布理财信息</span></td>
      </tr>
      <tr>
...
<TABLE style="BORDER-COLLAPSE: collapse" cellSpacing=1 cellPadding="4" width="100%" align="center" border=0>
			  ...
			  <TR>
				...
				<TD width="113" align="right" bgColor="#E5EFF7">起购金额：</TD>
				<TD width="373" height=20 align="left" bgColor="#E5EFF7"><input name="txtmoney" type="text"  id="txtmoney" size="30" maxlength="100" title="起购金额" class="a2"></TD>
			  </TR>
			  <TR>
				<TD align="right" width=131 bgColor="#E5EFF7">年利率：</TD>
				<TD width="363"  align="left" bgColor="#E5EFF7"><input name="txtyear" type="text"  id="txtyear" size="30" maxlength="100" title="年利率" class="a2"></TD>
              ...
              <TR>
				<TD align="right" width=131 bgColor="#E5EFF7">进度：</TD>
				<TD width="363"  align="left" bgColor="#E5EFF7"><input name="txtjindu" type="text"  id="txtjindu" size="30" maxlength="100" title="进度" class="a2"></TD>
