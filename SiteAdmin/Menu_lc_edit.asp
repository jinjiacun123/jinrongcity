...
server.ScriptTimeout=500000
	...
	'''删除小图
	  sql="select Server_filepath, Server_filename, Client_filename,id from sq_jinrongcity.[Lc_tab] where id="& upload.form("id")
		...
		conn.execute "update sq_jinrongcity.[Lc_tab] set Server_filename='' , Server_filepath='' , Client_filename='' where id="& upload.form("id")
		
		response.Redirect("Menu_lc_edit.asp?id="&upload.form("id"))	
	end if
	...
	if upload.form("butsave")<>""  then
		...
		news_sql="select * from sq_jinrongcity.[Lc_tab] where id=" & upload.form("id")
		if rs.state=1 then rs.close
	...
	if upload.form("butdel")="" then
		ID= GetParaNum("id")
		news_sql="select * from sq_jinrongcity.[Lc_tab] where id=" & ID
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="26" background="images/headerbg1.gif">&nbsp; <span class="headtext"><img src="images/dec_1.gif" width="11" height="11" align="absmiddle"> 编辑理财信息</span></td>
      </tr>
      <tr>
...
<TABLE cellSpacing=1 cellPadding="4" width="100%" align="center" border=0>
			 ...
			 <% if rs("Server_filepath")<>"" then %>
              ...
              <TR>
			      <TD align="right" bgColor="#E5EFF7">进度：</TD>
...
set rs2=server.CreateObject("ADODB.Recordset")		
	rs2.open "select a.id as plid,a.FNewID,a.dianpin,a.FType,b.ID from [UserPl_tab] a inner join sq_jinrongcity.[Lc_tab] b on a.FNewID=b.ID where a.FType=1 ",conn,1,3
...
%>
				...
				%>
                        <tr><td height="25px" style="color:#F00"><a href="Menu_lc_list_del.asp?id=<%=rs2("plid")%>"><%=rs2("dianpin")%></a>&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000">(*点击内容可删除)</font></td></tr>
                        <%
					rs2.movenext
					loop				
				%>
              ...
              <div align="center">
                <div align="right">
                  <div align="center">
					...
					%>">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="Submit" type="button" class="buttomw" value="返回列表" onClick="window.location.href='Menu_lc_list.asp'" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </div>
                </div>
              </div>
          </div></td>
