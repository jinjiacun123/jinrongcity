        ...
        <td>
         <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#EBEBEB">
            <tr>
			  ...
			  <td width="9%" background="images/headerbg1.gif"><div align="center" class="headtext">起购金额</div></td>
              <td width="8%" background="images/headerbg1.gif"><div align="center" class="headtext">年利率</div></td>
              <td width="7%" background="images/headerbg1.gif"><div align="center" class="headtext">期限</div></td>
              <td width="6%" background="images/headerbg1.gif"><div align="center" class="headtext">进度</div></td>
            ...
            <tr <%if i mod 2 = 1 then response.Write("bgcolor='#FFFFFF'") else response.Write("bgcolor='#FAFAFA'")%>>
              ...
              <td><div align="center"><img src="images/del.gif" width="16" height="16" align="absmiddle"><a href="Menu_lc_edit.asp?id=<%=rs_news("ID")%>">编辑</a></div></td>
            </tr>
			<% rs_news.movenext
	  else
        exit for
