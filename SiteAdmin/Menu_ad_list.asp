...
<%
	...
	set rs_ads = server.CreateObject("ADODB.recordset")
	ad_sql = "select * from sq_jinrongcity.[jr_ad]"
	...
	mypage0.getsql = ad_sql
	set rs_ads = mypage0.getrs() 	'返回Recordset		
%>
      ...
      <tr>
        <td>
         <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#EBEBEB">
            <tr>
              	...
              	<td width="11%" background="images/headerbg1.gif"><div align="center" class="headtext">位置</div></td>
              	<td width="30%" background="images/headerbg1.gif"><div align="center" class="headtext">标题</div></td>
		<td width="20%" background="images/headerbg1.gif"><div align="center" class="headtext">url</div></td>
		<td width="20%" background="images/headerbg1.gif"><div align="center" class="headtext">图片</div></td>
		<td width="6%" background="images/headerbg1.gif"><div align="center" class="headtext">点击量</div></td>
		...
		%>
            <tr <%if i mod 2 = 1 then response.Write("bgcolor='#FFFFFF'") else response.Write("bgcolor='#FAFAFA'")%>>              
              ...
              <td><div align="center"><%=rs_ads("location")%></div></td>
              <td><div align="center"><%=rs_ads("title")%></div></td>
	      <td><div align="left"><%=rs_ads("url")%></div></td>
              <td><div align="left"><%=rs_ads("img_url")%></div></td>
	      <td><div align="center"><%=rs_ads("click")%></div></td>
              <td><div align="center">
                    <img src="images/del.gif" width="16" height="16" align="absmiddle">
                            <a href="Menu_ad_edit.asp?id=<%=rs_ads("id")%>">编辑</a>
                    </div>
    	      </td>
            </tr>
			<% rs_ads.movenext
