...
set rs=Server.CreateObject("ADODB.Recordset")
	...
	news_sql=" select * from sq_jinrongcity.[Img_tab] where FParentID="& ID
	...
	<div class="main_left2">
			...
			<div class="content2">
				...
				<div class="crumbBox">
					...
					>
					<%if LmId=1 then%><a href="newslist.asp?pid=1">滚动图片</a>
					<%elseif LmId=2 then%><a href="newslist.asp?pid=2">观点</a>
                    <%elseif LmId=3 then%><a href="newslist.asp?pid=3">资讯</a>
                    <%elseif LmId=4 then%><a href="newslist.asp?pid=4">热点</a>
                    <%end if%></a>
					>正文
				</div>
