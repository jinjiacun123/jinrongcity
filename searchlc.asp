...
<div class="content3">
  ...
  <li><a href="productlcde.asp?id=<%response.Write(rs("id"))%>" target="_blank"><%=rs("content")%></a>
  <DIV style="HEIGHT:10px"></DIV>
  <strong style="color:#F30">星&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级：</strong><%=rs("xingji")%>
  <DIV style="HEIGHT:10px"></DIV>
  <strong style="color:#F30">主推产品：</strong>
  <DIV style="HEIGHT:10px"><%=rs("product")%></DIV>
  <strong style="color:#F30">点&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;评：</strong><%=rs("dianpin")%>
  </li></UL>
    <% rs.movenext
			  else
				exit for
